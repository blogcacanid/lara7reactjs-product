            ...
            <div className='container py-4'>
                <div className='row'>
                    <div className='col-md-6'>
                      <div className='card'>
                            <div className='card-header'><h3><i className="fas fa-edit"></i>&nbsp;Edit Record # {this.state.product_id}</h3></div>
                            <div className='card-body'>
                                <form onSubmit={this.handleUpdateProduct}>
                                    ...
                                    &nbsp;&nbsp;
                                    <button className='btn btn-primary' title="Update Record"><i className="fas fa-save"></i>&nbsp;Update Record</button>
                                    {this.state.alert}
                                </form>
                            </div>
                        </div>
