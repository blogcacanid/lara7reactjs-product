            ...
            <div className='container py-4'>
                <div className='row'>
                    <div className='col-md-6'>
                      <div className='card'>
                            <div className='card-header'><h3><i className="fas fa-trash"></i>&nbsp;Delete Record # {this.state.product_id}</h3></div>
                            <div className='card-body'>
                                <form onSubmit={this.handleDeleteProduct}>
                                    ...
                                    <Link className='btn btn-secondary' title="Cancel" to={'/'}><i className="fas fa-arrow-alt-circle-left"></i>&nbsp;Cancel</Link>
                                    &nbsp;&nbsp;
                                    <button className='btn btn-danger' title="Delete Record"><i className="fas fa-trash"></i>&nbsp;Delete Record</button>
                                    {this.state.alert}
                                </form>
                            </div>
                        </div>
