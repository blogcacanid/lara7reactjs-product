            ...
            <div className='container py-4'>
                <div className='row'>
                    <div className='col-md-6'>
                        <div className='card'>
                            <div className='card-header'><h3><i className="fas fa-plus-circle"></i>&nbsp;Add Record</h3></div>
                            <div className='card-body'>
                                <form onSubmit={this.handleCreateNewProduct}>
                                    ...
                                    &nbsp;&nbsp;
                                    <button className='btn btn-success' title="Save Record"><i className="fas fa-save"></i>&nbsp;Save Record</button>
                                    {this.state.alert}
                                </form>
                            </div>
                        </div>
